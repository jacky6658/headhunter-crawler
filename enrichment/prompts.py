...
# ============================================================
PROFILE_ANALYSIS_PROMPT = """你是專業獵頭顧問 AI。請搜尋並分析以下候選人的專業背景。

LinkedIn URL: {url}

**重要指示**：
1. 請嘗試訪問此 LinkedIn URL 獲取資訊
2. 如果無法直接訪問 LinkedIn 頁面，請使用搜尋功能查找此人的其他公開資訊（如 GitHub、個人網站、公司官網、新聞等）
3. 從 URL 中提取人名（通常在 /in/ 之後），用姓名搜尋更多資訊
4. 即使資訊有限，也請盡量根據找到的資訊填寫
